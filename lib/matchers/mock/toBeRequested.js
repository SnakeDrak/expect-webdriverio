...
function toBeRequestedFn(received, options = {}, driver) {
    return toBeRequestedTimes_1.toBeRequestedTimes.call({ ...(this || {}), expectation: 'called' }, received, { ...options, gte: 1 }, driver);
}

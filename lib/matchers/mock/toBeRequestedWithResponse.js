...
function toBeRequestedWithResponseFn(received, response, options = {}, driver) {
    return toBeRequestedWith_1.toBeRequestedWithFn.call(this, received, { response }, options, driver);
}
